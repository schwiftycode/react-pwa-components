...
const ScreenSwitcher = forwardRef((props, ref) => {
  ...
  useImperativeHandle(ref, _ => ({
    navigate(screenName, animation, duration, easing) {
      ...
      easing = easing || Easings.linearTween; // Prepare for Animation
  ...
  const animateSlideFromRight = (duration, easing) => {
    ...
    currentScreenContainer.current.style.transform = 'translate(0, 0)'; // Execute animation
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "ScreenSwitcher"
  }, /*#__PURE__*/React.createElement("div", {
    ref: nextScreenContainer,
    className: "NextScreenContainer"
  }, props.screens[nextScreen]), /*#__PURE__*/React.createElement("div", {
    ref: currentScreenContainer,
    className: "CurrentScreenContainer"
